...
public final class FragmentSeriesBinding implements ViewBinding {
  ...
  private FragmentSeriesBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar,
      @NonNull RecyclerView rvCategories, @NonNull RecyclerView rvSeries,
  ...
  public static FragmentSeriesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSeriesBinding((LinearLayout) rootView, progressBar, rvCategories, rvSeries,
          tvEmpty);
    }
