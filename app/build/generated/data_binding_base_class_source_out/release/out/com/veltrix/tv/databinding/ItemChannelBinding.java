...
public final class ItemChannelBinding implements ViewBinding {
  ...
  private ItemChannelBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivChannelIcon,
      @NonNull TextView tvChannelName) {
    this.rootView = rootView;
    this.ivChannelIcon = ivChannelIcon;
  ...
  public static ItemChannelBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.ivChannelIcon;
      ImageView ivChannelIcon = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemChannelBinding((LinearLayout) rootView, ivChannelIcon, tvChannelName);
    }
