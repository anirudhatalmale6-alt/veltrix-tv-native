...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull TextView rootView, @NonNull TextView tvCategoryName) {
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    TextView tvCategoryName = (TextView) rootView;

    return new ItemCategoryBinding((TextView) rootView, tvCategoryName);
  }
}
